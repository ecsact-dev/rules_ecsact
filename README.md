...
1. search for "rules_ecsact" and replace with the name you'll use for your workspace
1. search for "ecsact-dev" and replace with GitHub org
1. search for "ecsact" and replace with the language/tool your rules are for
1. rename directory "ecsact" similarly
